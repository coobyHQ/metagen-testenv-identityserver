...
%>
<form action="/samlsso" method="post" id="loginForm" class="grid" name="metagen-login">
    ...
    <form action="/oauth2/authorize" method="post" id="loginForm">
        ...
        <form action="../commonauth" method="post" id="loginForm">
            ...
            <div class="width-one-whole">         
                <fieldset>
                    <div>
                        <label for="username" class="float-left label-bold">Username</label>
                        ...
                        <input id="username" name="username" type="text" class="input-error" placeholder="Enter Username" ><span class="clear"></span>
                    </div>
                    <div>
                    ...
                    <div class="push-right spacer-top-2">
                        ...
                        <label class="showHideLabel" for="showHide">Show password</label></div>
                    <div>
                ...
                <button type="submit" class="gridworkz-gz-button gridworkz-gz-button-size-m button-metagen spacer-top-1">
                    ...
                    <span class="gridworkz-gz-button-text">Entra con SAML2 METAGEN</span>
                </button>
            </div>
