...
<!--[if gt IE 8]><!--><html class="no-js" lang="it"><!--<![endif]-->
	     ...
	     <div id="contain-all">
            <div class="inner">
                <div class="grid spacer-top-1">
                    <div class="width-one-whole metagen-logo"><img src="img/metagen-level1-logo-bb.svg" onerror="this.src='img/metagen-level1-logo-bb.png'; this.onerror=null;" alt="SAML2 METAGEN 1" /></div>
                </div>
                <div class="grid spacer-top-1">
                ...
                <div class="grid spacer-top-1 hidden">
                    <div class="width-one-half push-left metagen-link">
                        <a href="#">
                            Don't have a SAML2 METAGEN Log in? 
                            <img class="open-link" src="img/open-link.svg" onerror="this.src='img/open-link.png'; this.onerror=null;" alt="A new page opens" />
                        </a>
                    </div>
                    <div class="width-one-half push-right metagen-link">
                        <a href="#">
                            Cancel 
                            <img class="open-link" src="img/open-link.svg" onerror="this.src='img/open-link.png'; this.onerror=null;" alt="A new page opens" />
                        </a>
    ...
    <div id="footer">
	<div id="footer-inner">
            <a href="http://metagen.gridworkz.com/check" target="blank_"><img id="metagen-cooby-logo" src="img/metagen-cooby-logo-bb.svg" onerror="this.src='img/metagen-cooby-logo-bb.png'; this.onerror=null;" alt="SAML2 METAGEN - Gridworkz Software - Check" /></a>
        </div>
    </div>    
